...
function HeroGeometric({
    ...
    return (
        <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-[#030303] pt-20">
            ...
            <div className="relative z-10 container mx-auto px-4 md:px-6 flex flex-col lg:flex-row items-center gap-12 max-w-7xl">
                <div className="max-w-2xl text-center lg:text-left flex-1">
                    ...
                    <motion.div
                        ...
                        animate="visible"
                    >
                        <p className="text-base sm:text-lg md:text-xl text-white/40 mb-8 leading-relaxed font-light tracking-wide max-w-xl mx-auto lg:mx-0">
                            The unified operating system for campus finances, attendance, and dynamic student communities.
                        </p>
                    </motion.div>
                </div>
