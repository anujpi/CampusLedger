...
const MarqueeItem = () => (
  <div className="flex items-center space-x-12 px-6">
    <span>Next-Gen Campus Platform</span> <span className="text-primary/60">✦</span>
    <span>Unified Ecosystem</span> <span className="text-secondary/60">✦</span>
    <span>Real-time Engagement</span> <span className="text-primary/60">✦</span>
    <span>Smart Finance</span> <span className="text-secondary/60">✦</span>
    <span>Total Integration</span> <span className="text-primary/60">✦</span>
  </div>
);
        ...
        <footer className="fixed bottom-0 left-0 flex h-screen w-full flex-col justify-between overflow-hidden bg-black text-white cinematic-footer-wrapper">
            ...
            <div ref={linksRef} className="flex flex-col items-center gap-6 w-full">
              ...
              <div className="flex flex-wrap justify-center gap-4 w-full">
                <MagneticButton as="a" href="#" className="footer-glass-pill px-10 py-5 rounded-full text-white font-bold text-sm md:text-base flex items-center gap-3 group">
                  <svg className="w-6 h-6 text-neutral-400 group-hover:text-white transition-colors" viewBox="0 0 24 24" fill="currentColor">
          ...
          <div className="relative z-20 w-full pb-8 px-6 md:px-12 flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="text-neutral-500 text-[10px] md:text-xs font-semibold tracking-widest uppercase order-2 md:order-1">
              © 2026 CampusLedger. All rights reserved.
            </div>
            ...
            <div className="footer-glass-pill px-6 py-3 rounded-full flex items-center gap-2 order-1 md:order-2 cursor-default border-white/10">
              ...
              <span className="text-white font-black text-xs md:text-sm tracking-normal ml-1">Team</span>
            </div>
            ...
            <MagneticButton
              as="button"
              onClick={scrollToTop}
              className="w-12 h-12 rounded-full footer-glass-pill flex items-center justify-center text-neutral-400 hover:text-white group order-3"
            >
